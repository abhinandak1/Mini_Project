...
String privateKey =
    "0xb5cf3a682e32e315a5327b26e15bf9972fb5f9f80b14865d520487c461e0d5a3";
...
Widget CustomButton(text, fun) => Container(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor: Colors.blue[300], // background
          foregroundColor: Colors.blue[700], // foreground
        ),
        onPressed: fun,
        child: Padding(
